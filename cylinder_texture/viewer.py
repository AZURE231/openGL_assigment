...
from texturePyramid import *
from cylinder_side_text import *
...
def main():
    ...
    model = Circle("./phong_texture.vert", "./phong_texture.frag", 0.5, 0.5).setup()
    model1 = Circle("./phong_texture.vert", "./phong_texture.frag", 0.5, -0.5).setup()
    model3 = CylinderSide("./phong_texture.vert", "./phong_texture.frag", 0.5, 0.5).setup()
    viewer.add(model)
    viewer.add(model1)
    viewer.add(model3)
