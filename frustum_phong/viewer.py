...
def main():
    ...
    model = Circle("./phongex.vert", "./phongex.frag", 1, 1, numSide).setup()
    model2 = Circle("./phongex.vert", "./phongex.frag", 0.5, -0.5, numSide).setup()
    model3 = Cylinder_side("./gouraud.vert", "./gouraud.frag", 1, 1, numSide).setup()
    viewer.add(model)
    viewer.add(model2)
    viewer.add(model3)
