...
class TexCube(object):
    def __init__(self, vert_shader, frag_shader, pos, name):
    ...
    def drawSphere(self, radius, pos):
        ...
        for i in range(0, self.stackCount + 1):
            ...
            for j in range(0, self.sectorCount + 1):
                ...
                self.sphereVertices.append(x + pos[0])
                self.sphereVertices.append(y + pos[1])
                self.sphereVertices.append(z + pos[2])
