...
def main():
    ...
    model = Circle("./gouraud.vert", "./gouraud.frag", 1, 1).setup()
    model2 = Circle("./gouraud.vert", "./gouraud.frag", 1, -1).setup()
    model3 = Cylinder_side("./gouraud.vert", "./gouraud.frag", 1, 1).setup()
    viewer.add(model)
    viewer.add(model2)
    viewer.add(model3)
